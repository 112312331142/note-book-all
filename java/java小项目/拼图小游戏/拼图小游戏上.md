...
* 键盘监听 KeyListener
  ...
  | Modifier | 方法                    | 描述         |
  | -------- | ----------------------- | ------------ |
  | void     | KeyPressed(KeyEvent e)  | 点击         |
  | void     | KeyReleased(KeyEvent e) | 松开         |
...
* 鼠标监听 MouseListener
  ...
  | Modifier | 方法                        | 描述     |
  | -------- | --------------------------- | -------- |
  | void     | mouseClicked(MouseEvent e)  | 单击操作 |
  | void     | mouseEntered(MouseEvent e)  | 划入     |
  | void     | mouseExited(MouseEvent e)   | 划出     |
  | void     | mousePressed(MouseEvent e)  | 点击     |
